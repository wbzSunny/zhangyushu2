...
public class DateUtil {
     ...
     * @return
     */
    public static Integer getDaySecond() {
        return (60 * 60 * 24);
    }

    /**
     * mybatis-plus map类型转string类型date   2019-03-10T02:00:22
     *
     * @param datetime
     * @return
     */
    public static String mapToStr(Object datetime) {
        String time = String.valueOf(datetime);
        System.out.println(time);
        int indexStart = time.indexOf(".");
        String replace = time.replace("T", " ");
        return replace.substring(0, indexStart);
    }
     ...
     * @return
     */
    public static String mapToDateStr(Object datetime) {
        String time = String.valueOf(datetime);
        System.out.println(time);
        int indexStart = time.indexOf("T");
        return time.substring(0, indexStart);
    }
    ...
    public static String stampToDate(Long timestamp) {
        ...
        String sss = formatLocalDateTimeToString(time, TIME_PATTERN);
        return sss;
    }
